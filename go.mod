...
replace (
	// More info => https://github.com/kubernetes/kubernetes/issues/79384#issuecomment-505627280
	k8s.io/api => k8s.io/api v0.22.4
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.22.4 // indirect
	k8s.io/apimachinery => k8s.io/apimachinery v0.22.5-rc.0 // indirect
